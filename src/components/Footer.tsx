...
const Footer = () => {
  return (
    <footer className="px-6 md:px-12 lg:px-20 xl:px-32 py-12 border-t border-border flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
